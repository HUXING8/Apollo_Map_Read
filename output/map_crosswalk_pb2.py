...
_builder.BuildTopDescriptorsAndMessages(DESCRIPTOR, 'map_crosswalk_pb2', _globals)
if not _descriptor._USE_C_DESCRIPTORS:
  DESCRIPTOR._loaded_options = None
  _globals['_CROSSWALK']._serialized_start=71
  _globals['_CROSSWALK']._serialized_end=190
