...
_builder.BuildTopDescriptorsAndMessages(DESCRIPTOR, 'map_speed_bump_pb2', _globals)
if not _descriptor._USE_C_DESCRIPTORS:
  DESCRIPTOR._loaded_options = None
  _globals['_SPEEDBUMP']._serialized_start=72
  _globals['_SPEEDBUMP']._serialized_end=190
